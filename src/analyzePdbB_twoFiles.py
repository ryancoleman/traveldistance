...
def analyzePdbBCompareFiles(firstFilename, compareFilename):
  ...
  analyzePdbB.makeCompareResidueReport(residues, listFilename + ".residue.bfactor")
  #do alternate pvalue tests and by file comparisons with pdbs lists
  corrAll, corrBeta = analyzePdbB.makeCompareResidueReportAlternate(pdbs, \
                               listFilename + ".residue.alt.bfactor")
  #now do a p-value comparison that is corrected for the overall depth diffs
  analyzePdbB.makeCompareResidueReportAlternate(pdbs, \
                               listFilename + ".residue.alt.corr.bfactor", \
